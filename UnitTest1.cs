...
namespace TestCianbyShatohin
{
    public class Tests
    {
        ...
        private const string _login = "sasha.shvtoxin@mail.ru";
        ...
        private const string _password = "491625AzByKa";
        //кнопка разместить объявление
        private readonly By _placeAdBtn = By.XPath("//span[text()='+ Разместить объявление']");
        //тип акаунта - собственик
        private readonly By _sobstvBtn = By.XPath("//div[@data-mark='switcher_button||true']");
        ...
        //переменная адреса
        private const string _adress = "Ленинградская область, Всеволожский район, деревня Новое Девяткино, Арсенальная улица, 4, подъезд 4 ";
        //кнопка дальше
        ...
        //значение
        private const string _youtubeText = "https://www.youtube.com/watch?v=2ot7mDuS2K0";
        ...
        //значения
        private const string _photo1 = "C:\\Users\\sasha\\OneDrive\\Рабочий стол\\Работа\\фон.jpg";
        //поле описания квартиры
        private readonly By _aboutFlatTxt = By.TagName("textarea");
        //значение
        private const string _aboutFlatText = "Работу выполнил Шатохин Александр! ИП-20-3";
        //поле ввода цены
        ...
        //значение 
        private const string _numberText = "9992430751";
        ...
        public void TestPlaceAnAd()
        {
            ...
            Thread.Sleep(1000);
            // собственик
            var sobstBtn = driver.FindElement(_sobstvBtn);
            sobstBtn.Click();
            Thread.Sleep(2000);
            //продажа
